# phpMyAdmin template
This is a Dockerfile template to run phpMyAdmin on [mogenius](https://mogenius.com). We use it to deploy phpMyAdmin from our service library. If want to run your phpMyAdmin on mogenius feel free to add this Dockerfile to your project.
